...
//    [DebugMode open:YES];
    ...
    //初始化主机地址
    [Initialization initHost:@"http://www.weather.com.cn/data/sk/"];
    //初始化接口
    [Initialization initApi];
    //初始化用户文件
    [Initialization initUserFile];
...
{
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.PF-Lib.Project" in the application's documents directory.
